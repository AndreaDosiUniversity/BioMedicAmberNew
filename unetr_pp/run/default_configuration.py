...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
    ...
    print("THE NETWORK CONF IS ", network)
    print("THE TASK IS ", task)
    print("THE NETWORK TRAINER IS ", network_trainer)
    print("THE PLANS IDENTIFIER IS ", plans_identifier)
    ...
    if network == '2d':
        ...
        print("THE PLANS FILE IS ", plans_file)
    ...
    print("THE NETWORK TRAINER IS ", network_trainer)
    print("THE SEARCH IN IS ", search_in)
    print("THE CURRENT MODULE IS, ", base_module)
